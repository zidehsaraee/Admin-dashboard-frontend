...
const rows = [
  ...
  createData(
    `${process.env.PUBLIC_URL}/images/ProductsImg/hp-laptop.jpg`,
    "Laptop Hp",
    780,
    30
  ),
  ...
  createData(
    `${process.env.PUBLIC_URL}/images/ProductsImg/microphone.jpg`,
    "Microphone",
    48,
    16
  ),
  createData(
    `${process.env.PUBLIC_URL}/images/ProductsImg/monitor-arm-3.jpg`,
    "Monitor arm",
    25,
    11
  ),
  createData(
    `${process.env.PUBLIC_URL}/images/ProductsImg/monitor.jpg`,
    "Monitor",
    370,
    100
  ),
  createData(
    `${process.env.PUBLIC_URL}/images/ProductsImg/mouse1.jpg`,
    "Mouse",
    35,
    20
  ),
